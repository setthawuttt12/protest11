                ...
                <v-table>
                    ...
                    <tbody>
                        <tr v-for="(items, index) in result" :key="items.id_eva">
                            ...
                            <td class="text-center border"><v-btn color="blue" class="text-white" size="small"
                                    @click="check(items.id_eva)">ตรวจสอบ</v-btn></td>
                            <td class="text-center border">
                                <v-btn v-if="items.signature" color="success" class="text-white" size="small"
                                    @click="go(items.id_eva)">ยืนยันผลแล้ว</v-btn>
                                <v-btn v-else color="blue" class="text-white" size="small"
                                    @click="go(items.id_eva)">ยืนยันผล</v-btn>
                            </td>
                        </tr>
