                            ...
                            <tbody>
                                <tr v-for="(items,index) in result" :key="items.id_eva">
                                    ...
                                    <td class="border text-center">
                                        <v-btn class="text-center text-white ma-2" size="small" :color="bg(items.status_eva)">{{ items.status_eva === 1 ? 'รอการประเมินตนเอง' : items.status_eva === 2 ? 'รอกรรมการประเมิน' : 'ประเมินสำเร็จ' }}</v-btn>
                                    </td>
                                </tr>
                                <tr>
